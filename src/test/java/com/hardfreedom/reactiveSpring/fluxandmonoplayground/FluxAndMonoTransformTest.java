...
public class FluxAndMonoTransformTest {
    ...
    public void transformUsingFlatMap_usingParallel_maintain_order() {
        ...
        Flux<String> stringFlux = Flux.fromIterable(Arrays.asList("A", "B", "C", "D", "E", "F"))
                .window(2) //Flux<Flux<String>> -> (A, B), (C, D), (E, F)
//                .concatMap((s) -> //concatMap is the same as flatMap but it maintains the order
//                        s.map(this::convertToList).subscribeOn(parallel())) //Flux<List<String>>
                .flatMapSequential((s) -> //flatMapSequential does the same as concatMap but it is faster
