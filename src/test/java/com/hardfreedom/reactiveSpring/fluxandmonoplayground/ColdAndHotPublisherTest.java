...
public class ColdAndHotPublisherTest { //This class shows how data will flow if there are multiple subscribers
    ...
    public void coldPublisherTest() throws InterruptedException {
        ...
        stringFlux.subscribe(s -> System.out.println("Subscriber 2: " + s));//emits values form beginning
